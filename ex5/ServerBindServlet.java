...
/**
 * Servlet implementation class ServerBindServlet
 */
@WebServlet("/ServerBindServlet")
public class ServerBindServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			//param.put("connection.openfile", "http://127.0.0.1:8080/oz51/RemainStatus.ozd");
			//param.put("client_browser", strClient);
...
//			param.put("viewer.largebundle", "true");
			...
			//param.put("connection.reportname", "/fims/sap/mm/buy_dgnt_form.ozr");
			...
			if (o == null) {
				...
				if(!fileDownType.equalsIgnoreCase("inline")){
			        ...
			        if (isSave)
			        {   
			        	System.out.println("<br>Check : " + exportResultKey);
			        } 
				}
			} // end else
		} catch (Throwable e) {
